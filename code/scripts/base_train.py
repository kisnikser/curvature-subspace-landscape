...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="if set, log scalars to TensorBoard here (rank 0 only); e.g. code/.nanochat/tensorboard/my_run",
)
# Runtime
...
tb_writer = None
if args.tensorboard_dir is not None and master_process:
    from torch.utils.tensorboard import SummaryWriter

    os.makedirs(args.tensorboard_dir, exist_ok=True)
    tb_writer = SummaryWriter(log_dir=args.tensorboard_dir)
    print0(f"TensorBoard log dir: {args.tensorboard_dir}")
...
while True:
    ...
    if args.eval_every > 0 and (last_step or step % args.eval_every == 0):
        ...
        if tb_writer is not None:
            ...
            tb_writer.add_scalar("total_training_flops", flops_so_far, step)
        model.train()
    ...
    if args.core_metric_every > 0 and (last_step or (step > 0 and step % args.core_metric_every == 0)):
        ...
        if tb_writer is not None:
            tb_writer.add_scalar("core_metric", results["core_metric"], step)
        model.train()
