...
The approximation error is never exactly zero due to higher-order contributions, but is reliably small for $\sigma\le10^{-3}$.
...
\begin{figure}[t]
    ...
    \caption{Relative error of the quadratic Taylor approximation vs.\ perturbation scale $\sigma$ (mean and standard deviation across seeds, nanochat \texttt{d6} model, step~3500). The quadratic model is reliable for $\sigma\le10^{-3}$; this regime defines the valid operating range for proxy-based estimators.}
    \label{fig:exp-1}
\end{figure}
